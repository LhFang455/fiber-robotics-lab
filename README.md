...
FBG 波长变化采用：Δλ<sub>B</sub> = λ<sub>B</sub>[(1 − p<sub>e</sub>)ε + k<sub>T</sub>ΔT]。网站还以解析教学模型展示 Rayleigh/OFDR 连续应变、DAS 时空振动、Brillouin 频移、Raman 温度、Stokes 偏振态、Sagnac 相位与 EFPI 干涉谱。
