...
| 2 | 纵向真应变 $\varepsilon_{xx}$ | 无量纲 |
| 3 | 横向真应变 $\varepsilon_{yy}$ | 无量纲 |
| 4 | 横向真应变 $\varepsilon_{zz}$ | 无量纲 |
| 5 | 纵向正应力 $\sigma_{xx}$ | Pa（N/m²） |
| 6 | 横向正应力 $\sigma_{yy}$ | Pa（N/m²） |
| 7 | 横向正应力 $\sigma_{zz}$ | Pa（N/m²） |
| 8 | 温度 | K |
